...
const BookIssueForm = dynamic(() => import("./forms/BookIssueForm"), {
  loading: () => <h1>Loading...</h1>,
});
...
const forms: {
  ...
  book: (setOpen, type, data, relatedData, table) => (
    <BookForm
      type={type}
      data={data}
      setOpen={setOpen}
  ...
  parent: (setOpen, type, data, relatedData, table) => (
    <ParentForm
      type={type}
      data={data}
      setOpen={setOpen}
  ...
  staff: (setOpen, type, data, relatedData, table) => (
    <StaffForm
      type={type}
      data={data}
      setOpen={setOpen}
  ...
  feePayment: (setOpen, type, data, relatedData, table) => (
    <FeePaymentForm
      type={type}
      data={data}
      setOpen={setOpen}
  ...
  attendance: (setOpen, type, data, relatedData, table) => (
    <AttendanceForm
      type={type}
      data={data}
      setOpen={setOpen}
  ...
  assignment: (setOpen, type, data, relatedData, table) => (
    <AssignmentForm
      type={type}
      data={data}
      setOpen={setOpen}
  ...
  studyMaterial: (setOpen, type, data, relatedData, table) => (
    <StudyMaterialForm
      type={type}
      data={data}
      setOpen={setOpen}
  ...
  bookIssue: (setOpen, type, data, relatedData, table) => (
    <BookIssueForm
      type={type}
      data={data}
      setOpen={setOpen}
